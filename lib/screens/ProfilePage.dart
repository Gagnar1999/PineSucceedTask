                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(provider.user?.displayName?.capitalize()??"", style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),),
                        Text(provider.user?.email??"", style: const TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold),),
                        Text("E-mail Verified: ${provider.user?.emailVerified??false}", style: const TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.bold),)
                      ],
                    ),
                  )
                ],
